...
const mockCategories = [
  { id: '1', name: 'Hackathons', slug: 'hackathons', sortOrder: 1, isActive: true, oppCount: 154 },
  { id: '2', name: 'Internships', slug: 'internships', sortOrder: 2, isActive: true, oppCount: 89 },
  { id: '3', name: 'Events', slug: 'events', sortOrder: 3, isActive: true, oppCount: 320 },
  { id: '4', name: 'Competitions', slug: 'competitions', sortOrder: 4, isActive: true, oppCount: 45 },
]
          ...
          <tbody className="divide-y">
            {mockCategories.map((cat) => (
              <tr key={cat.id} className="hover:bg-muted/20 transition-colors">
                <td className="px-6 py-4 text-muted-foreground font-mono">{cat.sortOrder}</td>
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
              <form className="space-y-4">
                <div>
                  ...
                  <input type="text" className="w-full px-4 py-2 rounded-xl border bg-background" placeholder="e.g. Hackathons" required />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="number" className="w-full px-4 py-2 rounded-xl border bg-background" defaultValue="10" required />
                </div>
              </form>
            </div>
